...
const makeFormValue = () =>
  createSelector(selectHighestState, highestState =>
    getFormValues('wizard')(highestState),
  );

const makeSelectAnswers = () =>
  createSelector(selectGlobal, globalState => globalState.answers);

const makeSelectQuestions = () =>
  createSelector(selectGlobal, globalState => globalState.questions);
